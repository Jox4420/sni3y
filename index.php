...
<body>
<img class="i" src="./صنايعي 2.png" alt="">
  <!--  -->
<style>
        * {
  margin: 0;
...
body {
  width: 100%;
  min-height: 100vh;
  background-image: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)) url(صنايعي2.png );
...
@media (max-width: 430px) {
  ...
  .container .login-social a {
	...
	<div class="container">
      ...
      <p class="login-register-text">got to home page? <a href="./home.php">Home page</a>.</p>
		</form>
	</div>
</body>
</html>